 ...
 * @property string $dokter_tindakan
...
class Tindakan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pendaftaran_id, deskripsi_tindakan, obat_id', 'required'),
			array('pendaftaran_id, obat_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, deskripsi_tindakan, obat_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'users' => array(self::HAS_MANY, 'User', 'tindakan_id'),
			'pendaftaran' => array(self::BELONGS_TO, 'PendaftaranDokter', 'pendaftaran_id'),
	...
	public function search()
	{
		...
		$criteria->compare('deskripsi_tindakan',$this->deskripsi_tindakan,true);
